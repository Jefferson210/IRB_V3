class IrbSelectionsPicture < ActiveRecord::Base
    ...
    has_attached_file :picture, styles: { medium: "600x600>", thumb: "300x300>" }, :path => ":rails_root/public/assets/images/irbSelections/:id/:filename",
    :url => "/assets/images/irbSelections/:id/:filename"
